...
def test_db_problem_to_summary(problem_entry_fixture):
    """Test conversion of ProblemEntry to ProblemSummary"""
    summary = db_problem_to_summary(problem_entry_fixture)
